...
Next Action: I ran the windows PowerShell as an administrator and entered the command; netstat -ano, to see the list of active connections. The list below shows that port 135/tcp has PID of 1592. The PID is process ID and it is useful in finding out which connection is attached to a specific service.
